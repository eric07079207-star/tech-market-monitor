...
EXPORTS = [
    ...
    ExportItem("backtest/factor_effectiveness.parquet", "07_預測驗證", "因子有效性報告", "技術與市場壓力因子依歷史分層樣本計算的後續報酬與回撤；不宣稱因果關係。"),
    ...
    ExportItem("kg/kg_prediction_v2_log.parquet", "09_金融知識圖譜", "KG研究觀察預測V2", "多因子趨勢預測、實際報酬、回撤、基準訊號與信心校準紀錄。"),
    ExportItem("kg/historical_backtest_readiness.parquet", "09_金融知識圖譜", "KG歷史回測準備度", "逐樣本標示歷史多來源事件與 point-in-time 基本面的可用性，防止缺資料的回測被誤讀。"),
